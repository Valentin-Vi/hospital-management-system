...
const ITEM_PRESETS = [
  ...
  { quantity: 250, minimun_quantity: 80 },
  { quantity: 100, minimun_quantity: 25 },
  { quantity: 60, minimun_quantity: 20 },
  { quantity: 500, minimun_quantity: 150 },
  { quantity: 400, minimun_quantity: 120 },
  { quantity: 150, minimun_quantity: 50 },
  { quantity: 80, minimun_quantity: 30 },
  { quantity: 120, minimun_quantity: 40 },
  { quantity: 200, minimun_quantity: 60 },
...
async function main() {
  ...
  for (let i = 0; i < createdMedications.length; i++) {
    ...
    const preset = ITEM_PRESETS[i] ?? { quantity: 0, minimun_quantity: 0 };
